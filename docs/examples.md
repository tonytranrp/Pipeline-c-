...
- Treat only the branch/join and export slices listed in `docs/production-readiness.md` as supported; parallel all-branches fan-in joins, stable descriptor/export compatibility, CLI/file export, and optional backends remain roadmap items.
