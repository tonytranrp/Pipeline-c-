...
- Branch, join, graph export, observer hooks, and optional backend execution are roadmap items, not current guarantees. See [Graph Export Roadmap / Status](graph-export-roadmap.md) for the current export-specific boundary and planned follow-on work.
