...
Latest validation snapshot: code SHA `6805543ede6946aa283be7f24fb3736c762f47b2` passed the cross-compiler workflow on 2026-05-18: GCC C++20/C++23 `150/150`, Clang C++20/C++23 `150/150`, MSVC C++20 `149/149`, and clean Ubuntu `package-release-clang-ninja` `150/150` plus TGZ package generation. See [Cross-Compiler Validation Status](cross-compiler-validation.md). A final release tag should rerun this workflow if non-doc code changes land after that SHA.
...
- Cross-compiler validation has current evidence for GCC C++20/C++23, Clang C++20/C++23, MSVC C++20, and clean Ubuntu package-release on code SHA `6805543`; rerun on the final tag candidate if additional non-doc code changes land. MSVC C++23, Windows package-release, C++26 gates, and other platform/package-manager matrices remain unclaimed.
