...
Keep release notes and examples aligned with that boundary. Do not present the current compile-time descriptor helpers as if they already satisfy the roadmap-level runtime descriptor contract.
